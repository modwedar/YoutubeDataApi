                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  Text(
                                                    videoData?.video?.subscribeCount ??
                                                        '',
                                                    style: TextStyle(
                                                        color: white
                                                            .withOpacity(0.4),
                                    ...
                                    ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          onTap: () {
                                            String videoId = videoData!.videosList[index].videoId!;
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            const EdgeInsets
                                                                .all(3.0),
                                                            child: Text(
                                                              videoData!.videosList[index].duration ??
                                                                  "00:00",
                                                              style: TextStyle(
                                                                  fontSize:
                                                                  12,
                                                      ...
                                                      children: <Widget>[
                                                        SizedBox(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: <Widget>[
                                                              Text(
                                                                videoData!.videosList[index].title ?? unknown,
                                                                style: TextStyle(
                                                                    color: white
                                                                        .withOpacity(
                                                                        0.9),
                                                              ...
                                                              Text(
                                                                videoData!.videosList[index].channelName ??
                                                                    unknown,
                                                                style: TextStyle(
                                                                    color: white
                                                                        .withOpacity(
